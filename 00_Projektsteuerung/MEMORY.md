...
- **Rest der langen Wunschliste (noch offen, nicht priorisiert)**: Wochenvolumen-Trend über mehrere Wochen statt nur der aktuellen, Kalender-/Streak-Ansicht im Tagebuch, Notizen pro Trainingseinheit statt nur pro Übung, konfigurierbarer Ruhetimer (Compound vs. Isolation, Push-Benachrichtigung im Hintergrund), KI-Übungstausch als Dialog statt Einbahnstraße. Noch nicht im Detail bewertet/priorisiert — bei Bedarf gemeinsam mit dem Nutzer eine neue Reihenfolge festlegen, gleiches Vorgehen wie bei Phase 1-4.
